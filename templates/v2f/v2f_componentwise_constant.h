...
VMATH_INLINE vm_v2f_t vm_addc_v2f(const vm_v2f_t a, const vm_float32_t constant)
{
	...
	// clang-format off
        ...
        vm_v2f_t out;
        out.inner = _mm_add_ps(a.inner, vm_splat_v2f(constant).inner);
        return out;
    #else
...
#error RISCV vector extensions not implemented
	...
	vm_v2f_t output;
#ifdef VMATH_USE_DISTINCT_TYPE_V2
	output.inner.buffer[0] = a.inner.buffer[0] SCALAR_OP constant;
	output.inner.buffer[1] = a.inner.buffer[1] SCALAR_OP constant;
#else
