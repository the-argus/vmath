...
VMATH_INLINE vm_v2f_t vm_add_v2f(const vm_v2f_t a, const vm_v2f_t b)
{
	...
	// clang-format off
        ...
        vm_v2f_t out;
        out.inner = _mm_add_ps(a.inner, b.inner);
        return out;
    #else
...
#error RISCV vector extensions not implemented
	...
	vm_v2f_t output;
#ifdef VMATH_USE_DISTINCT_TYPE_V2
	output.inner.buffer[0] = a.inner.buffer[0] SCALAR_OP b.inner.buffer[0];
	output.inner.buffer[1] = a.inner.buffer[1] SCALAR_OP b.inner.buffer[1];
#else
