...
VMATH_INLINE vm_2batch_v2f_t vm_mul_2xv2f_constant(const vm_2batch_v2f_t a,
												   const float b)
{
#define VMATH_MUL_2XV2_CONSTANT_SCALAR()                                       \
	...
	return _mm_mul_ps(a, vm_splat_2xv2f(b));
#else
	VMATH_MUL_2XV2_CONSTANT_SCALAR()
...
#error ARM SIMD not implemented
	...
	VMATH_MUL_2XV2_CONSTANT_SCALAR()
#endif
#undef VMATH_MUL_2XV2_CONSTANT_SCALAR
}
