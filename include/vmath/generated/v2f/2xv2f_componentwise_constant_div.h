...
VMATH_INLINE vm_2batch_v2f_t vm_div_2xv2f_constant(const vm_2batch_v2f_t a,
												   const float b)
{
#define VMATH_DIV_2XV2_CONSTANT_SCALAR()                                       \
	...
	return _mm_div_ps(a, vm_splat_2xv2f(b));
#else
	VMATH_DIV_2XV2_CONSTANT_SCALAR()
...
#error ARM SIMD not implemented
	...
	VMATH_DIV_2XV2_CONSTANT_SCALAR()
#endif
#undef VMATH_DIV_2XV2_CONSTANT_SCALAR
}
