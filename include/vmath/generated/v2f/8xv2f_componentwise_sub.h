VMATH_INLINE vm_8batch_v2f_t vm_sub_8xv2f(const vm_8batch_v2f_t a,
										  const vm_8batch_v2f_t b)
{
#define VMATH_SUB_8XV2_SCALAR()                                                \
...
#pragma unroll
	for (int8_t i = 0; i < 4; ++i) {
		result.buffer[i] = _mm_sub_ps(a.buffer[i], b.buffer[i]);
	}
	return result;
#endif
#else
	VMATH_SUB_8XV2_SCALAR()
