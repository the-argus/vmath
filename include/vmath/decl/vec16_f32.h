...
VMATH_INLINE vm_v16f_t vm_add_v16f(vm_v16f_t a, vm_v16f_t b);
/// Subtract a 16 element float32 vector from another, componentwise
VMATH_INLINE vm_v16f_t vm_sub_v16f(vm_v16f_t a, vm_v16f_t b);
/// Multiply two 16 element float32 vectors together, componentwise
VMATH_INLINE vm_v16f_t vm_mul_v16f(vm_v16f_t a, vm_v16f_t b);
/// Divide a 16 element float32 vector by another, componentwise
VMATH_INLINE vm_v16f_t vm_div_v16f(vm_v16f_t a, vm_v16f_t b);

/// Add a constant float32 value to all the elements of a 16 element vector
VMATH_INLINE vm_v16f_t vm_addc_v16f(vm_v16f_t a, vm_float32_t b);
/// Subtract a constant float32 value from all the elements of a 16 element
/// vector
VMATH_INLINE vm_v16f_t vm_subc_v16f(vm_v16f_t a, vm_float32_t b);
/// Multiply all the elements of a 16 element vector by a constant float32 value
VMATH_INLINE vm_v16f_t vm_mulc_v16f(vm_v16f_t a, vm_float32_t b);
/// Divide all the elements of a 16 element vector by a constant float32 value
VMATH_INLINE vm_v16f_t vm_divc_v16f(vm_v16f_t a, vm_float32_t b);
