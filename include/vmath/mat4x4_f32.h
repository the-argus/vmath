...
vm_load_rotation_pitch_yaw_rollv_mat4x4f(vm_v3f_t angles)
{
    ...
    // TODO: optimize these full shuffles, some cases can dont need full shuffle and select
    __m128 p0;
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(p0, sin_angles, cos_angles, _MM_SHUFFLE(0, 2, 2, 0), vm_v4_selectmask_1011)
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(y0, sin_angles, cos_angles, _MM_SHUFFLE(1, 0, 0, 1), vm_v4_selectmask_0111)
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(p1, sin_angles, cos_angles, _MM_SHUFFLE(2, 2, 2, 2), vm_v4_selectmask_1010)
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(y1, sin_angles, cos_angles, _MM_SHUFFLE(1, 1, 1, 1), vm_v4_selectmask_1100)
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(p2, sin_angles, cos_angles, _MM_SHUFFLE(2, 2, 2, 2), vm_v4_selectmask_0101)
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(p3, sin_angles, cos_angles, _MM_SHUFFLE(1, 1, 1, 1), vm_v4_selectmask_0011)

    // select { sin.x, sin.x, sin.x, sin.x }
    // NOLINTNEXTLINE
    const __m128 y2 = _mm_shuffle_ps(sin_angles, sin_angles, _MM_SHUFFLE(0, 0, 0, 0));
    ...
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(v1, q0, q2, _MM_SHUFFLE(1, 2, 3, 3), vm_v4_selectmask_1010)
    // XMVECTOR V2 = XMVectorPermute<XM_PERMUTE_0X, XM_PERMUTE_1X, XM_PERMUTE_0W, XM_PERMUTE_0W>(Q0, NS);
    // NOLINTNEXTLINE
    VMATH_SSE_FULL_SHUFFLE(v2, q0, ns, _MM_SHUFFLE(0, 0, 3, 3), vm_v4_selectmask_0100)
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wuninitialized"
	matrix = _mm512_insertf32x4(matrix, vm_select_v4f(vm_v4_zero.vector_rep, v0, vm_v4_selectmask_1110.vector_rep), 0);
#pragma clang diagnostic pop
	matrix = _mm512_insertf32x4(matrix, vm_select_v4f(vm_v4_zero.vector_rep, v1, vm_v4_selectmask_1110.vector_rep), 1);
	matrix = _mm512_insertf32x4(matrix, vm_select_v4f(vm_v4_zero.vector_rep, v2, vm_v4_selectmask_1110.vector_rep), 2);
	matrix = _mm512_insertf32x4(matrix, vm_mat4x4_iden_row3.vector_rep, 3);
#elif defined(VMATH_AVX256_GENERIC_ENABLE)
	matrix.buffer[0] = _mm256_insertf128_ps(matrix.buffer[0], vm_select_v4f(vm_v4_zero.vector_rep, v0, vm_v4_selectmask_1110.vector_rep), 0);
	matrix.buffer[0] = _mm256_insertf128_ps(matrix.buffer[0], vm_select_v4f(vm_v4_zero.vector_rep, v1, vm_v4_selectmask_1110.vector_rep), 1);
	matrix.buffer[1] = _mm256_insertf128_ps(matrix.buffer[1], vm_select_v4f(vm_v4_zero.vector_rep, v2, vm_v4_selectmask_1110.vector_rep), 0);
	matrix.buffer[1] = _mm256_insertf128_ps(matrix.buffer[1], vm_mat4x4_iden_row3.vector_rep, 1);
#else
    matrix.buffer[0] = vm_select_v4f(vm_v4_zero.vector_rep, v0, vm_v4_selectmask_1110.vector_rep);
    matrix.buffer[1] = vm_select_v4f(vm_v4_zero.vector_rep, v1, vm_v4_selectmask_1110.vector_rep);
    matrix.buffer[2] = vm_select_v4f(vm_v4_zero.vector_rep, v2, vm_v4_selectmask_1110.vector_rep);
    matrix.buffer[3] = vm_mat4x4_iden_row3.vector_rep;
#endif
